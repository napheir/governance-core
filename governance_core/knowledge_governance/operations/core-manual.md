...
```
pythonProject1/shared_state/knowledge/dashboard.html
```
...
cd C:\Users\naphe\AppData\Local\Programs\Python\Python311\pythonProject1\agent-core
...
应该都返回 `declarative` → `pythonProject1/`，source 指向各 clone 的
