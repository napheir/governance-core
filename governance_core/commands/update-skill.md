...
for clone in agent-rules agent-trade agent-data agent-research; do
  echo "=== $clone ==="
  cd ../$clone && echo '{}' | python /c/Users/naphe/AppData/Local/Programs/Python/Python311/pythonProject1/agent-core/.claude/hooks/session-context.py 2>&1 | grep -E "SKILL DRIFT" || echo "(clean)"
  cd /c/Users/naphe/AppData/Local/Programs/Python/Python311/pythonProject1/agent-core
done
```
